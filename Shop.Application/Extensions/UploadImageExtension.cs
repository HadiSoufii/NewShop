...
namespace Shop.Application.Extensions
{
    ...
    {
        public static bool AddImageToServer(this IFormFile image, string fileName, string orginalPath, int? width, int? height, string? thumbPath, string? deletefileName)
        {
